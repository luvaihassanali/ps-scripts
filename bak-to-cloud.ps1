...
$oldFiles = Get-ChildItem $targetDir -Exclude "repos" | Get-ChildItem -Recurse -Force -File
$files = Get-ChildItem $sourceDir -Exclude "repos" | Get-ChildItem -Recurse -Force -File
$dirs = Get-ChildItem $sourceDir -Exclude "repos" | Get-ChildItem -Recurse -Force -Directory
$rootDirs = Get-ChildItem $sourceDir -Exclude "repos" -Directory
