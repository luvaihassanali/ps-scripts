...
#$devConnection = Get-CrmConnection -Verbose -ConnectionString "AuthType=ClientSecret;Url=$devUrl;ClientId=gud;ClientSecret=secret" -MaxCrmConnectionTimeOutMinutes 10
$isOnPrem = "false"
